   ...
   <tr align="left" bgcolor="#DFEEEA">
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
	  ...
	  ?>
        ...
        <td width="5%"><a class="one" href="update_admin.php?user=<?php echo $row['username'];?>">Edit</a></td>
        <td width="5%">&nbsp;</td>
      </tr> 
      <?php 
       $color="2";}
   ...
   <tr align="left" bgcolor="#f2f2f2">
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
	  ...
	  ?>
        ...
        <td width="5%"><a class="one" href="delete_user.php?user_id=<?php echo $row['user_id'];?>">Delete</a></td>
      </tr> 
      <?php 
       $color="2";}
	   else{
	  ...
	  ?>
        ...
        <td>&nbsp;<?php echo $row['telephone']; ?></td>
        <td width="5%"><a class="one" href="update_user.php?user_id=<?php echo $row['user_id'];?>">Edit</a></td>
        <td width="5%"><a class="one" href="update_status.php?user_id=<?php echo $row['user_id'];?>">Delete</a></td>
      </tr>
	   <?php
	    $color="1";
	   }
