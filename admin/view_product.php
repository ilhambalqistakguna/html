...
<a href="index.php">HOME</a>
  ...
  <b>Report</b>
  <a href="report_user">User Report</a>
   ...
   <tr align="left" bgcolor="#204051">
    ...
    <tr align="left" bgcolor="#204051">
	  ...
	  if ($numrow==0)
	  	{
		 echo '<tr>
    				<td colspan="8"><font color="#204051">No record avaiable.</font></td>
 			   </tr>'; 
		}
	  ?>
    </table>
...
<br>
  ...
  <h3>Car Not Available</h3>
	<?php
		$query = "SELECT * FROM car  WHERE status = '2'";
		$result = mysqli_query($dbconn, $query) or die ("Error: " . mysqli_error($dbconn));
		$numrow = mysqli_num_rows($result);
	?>
   <tr align="left" bgcolor="#3b6978">
    <td>
    <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0">
